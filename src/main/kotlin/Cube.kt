...
/**
 * Based on [liorgonnen/kotlin-three-js-starter](https://github.com/liorgonnen/kotlin-three-js-starter).
 */
class Cube {
    ...
    private val cube =
        Mesh(BoxGeometry(1, 1, 1), MeshPhongMaterial().apply { color = Color(0x0000ff) })
